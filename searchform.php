...
<form role="search" method="get" class="search-form relative flex items-center" action="<?php echo esc_url(home_url('/')); ?>">
	...
	<input type="search" id="search-field-<?php echo uniqid(); ?>" class="search-field w-full py-2 pl-4 pr-12 border border-gray-300 rounded-md focus:outline-none focus:border-purple transition-colors 2xl:w-64" placeholder="<?php echo esc_attr_x('Search&hellip;', 'placeholder', 'goodshep-theme'); ?>" value="<?php echo get_search_query(); ?>" name="s" />
