...
<section <?php echo $section_id; ?> class="<?php echo esc_attr( $block_classes ); ?>" style="<?php echo esc_attr( $bg_style ); ?>">
    <div class="container mx-auto px-4">
        ...
        <?php if ( $text ) : ?>
            <div class="mb-16 max-w-2xl text-xl leading-relaxed prose max-w-none">
                ...
                ?>
                    <div class="grid grid-cols-3 gap-6 mb-8">
                        ...
                        <div class="col-span-2 flex flex-col">
                            ...
                            <?php if ( $email ) : ?>
                                <a href="mailto:<?php echo esc_attr( $email ); ?>" class="text-sm text-purple-600 hover:text-purple-800 transition-colors break-words mt-auto">
