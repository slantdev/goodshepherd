                        ...
                        <div class="pt-14 px-8 pb-8 flex flex-col flex-grow">
                            ...
                            <?php if ( $card_title ) : ?>
                                <h3 class="text-2xl lg:text-3xl font-semibold mb-6">
                                    <?php if ( $card_url ) : ?>
                                        <a href="<?php echo esc_url( $card_url ); ?>" class="text-gray-900 hover:text-purple-600 transition-colors no-underline">
                            ...
                            <?php if ( $button_text && $card_url ) : ?>
                                <div class="mt-auto">
                                    <a href="<?php echo esc_url( $card_url ); ?>" class="text-red-600 font-medium uppercase tracking-wider hover:text-red-800 transition-colors no-underline">
