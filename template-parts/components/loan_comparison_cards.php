                ...
                ?>
                    <div class="border border-gray-400 rounded-lg px-6 py-8 divide-y divide-gray-200 bg-white h-full flex flex-col">
                        ...
                        <div class="pb-6 flex-grow">
                            <?php if ( $icon ) : ?>
                                <div class="mb-6 w-12 h-12 text-purple-600">
                        ...
                        <div class="py-8">
                            ...
                            <div class="grid grid-cols-2 gap-3">
                                ...
                                if ( ! empty( $btn1_group['add_button'] ) && ! empty( $btn1_group['button_link'] ) ) : 
                                    $b1 = $btn1_group;
                                ?>
                                    <a href="<?php echo esc_url( $b1['button_link'] ); ?>" class="text-center py-3 border border-purple-600 text-purple-600 rounded font-medium hover:bg-purple-50 transition-colors no-underline text-sm">
                                ...
                                if ( ! empty( $btn2_group['add_button'] ) && ! empty( $btn2_group['button_link'] ) ) : 
                                    $b2 = $btn2_group;
                                ?>
                                    <a href="<?php echo esc_url( $b2['button_link'] ); ?>" class="text-center py-3 bg-red-600 text-white rounded font-medium hover:bg-red-700 transition-colors no-underline text-sm">
