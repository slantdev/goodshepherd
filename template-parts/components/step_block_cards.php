...
<section <?php echo $section_id; ?> class="<?php echo esc_attr( $block_classes ); ?>" style="<?php echo esc_attr( $bg_style ); ?>">
    <div class="container mx-auto px-4">
        ...
        <?php if ( $title ) : ?>
            <h2 class="font-semibold text-red-600 mb-6 lg:mb-16 text-3xl"><?php echo esc_html( $title ); ?></h2>
        <?php endif; ?>
        ...
        <?php if ( have_rows('step_block_cards') ) : ?>
            <div class="grid md:grid-cols-3 gap-8 lg:gap-12 md:px-12">
                ...
                ?>
                    <div class="border border-purple-600 rounded-lg p-6 h-full">
                        
                        <div class="flex items-center mb-4">
                            <div class="bg-purple-600 text-white rounded-full flex h-8 w-8 justify-center items-center text-base flex-shrink-0 mr-4">
                                <?php echo intval( $i ); ?>
                            </div>
