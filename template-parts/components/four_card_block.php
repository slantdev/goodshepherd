...
<section <?php echo $section_id; ?> class="<?php echo esc_attr( $block_classes ); ?>" style="<?php echo esc_attr( $bg_style ); ?>">
    <div class="container mx-auto px-4">
        ...
        <?php if ( $text ) : ?>
            <div class="mb-14 max-w-4xl prose max-w-none">
        ...
        <?php if ( have_rows('card_block_cards') ) : ?>
            <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
                ...
                ?>
                    <div class="bg-gray-50 border border-gray-300 p-8 rounded-lg hover:shadow-lg transition-shadow duration-200 relative mt-4">
                        
                        <?php if ( $icon ) : ?>
                            <div class="absolute top-0 right-0 -mt-4 -mr-4 h-12 w-12">
                                <?php echo goodshep_icon( array( 'icon' => $icon, 'class' => 'h-full w-full text-purple-600 fill-current' ) ); ?>
                            </div>
                        <?php endif; ?>

                        <div class="relative z-10">
                            <?php if ( $card_title ) : ?>
                                <h3 class="text-purple-600 text-xl font-semibold mb-4 pr-8"><?php echo esc_html( $card_title ); ?></h3>
                            <?php endif; ?>
