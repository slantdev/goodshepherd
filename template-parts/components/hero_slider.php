...
<section <?php echo $section_id; ?> class="<?php echo esc_attr($block_classes); ?>">
    ...
    <?php if (!empty($slides)) : ?>
        <div class="swiper hero-slider w-full h-[600px] lg:h-[700px]">
                ...
                ?>
                    <div class="swiper-slide relative flex items-center justify-center bg-gray-900 overflow-hidden">
                        ...
                        <div class="container mx-auto px-4 relative z-10 text-center">
                            <div class="max-w-4xl mx-auto" style="<?php echo esc_attr($text_style); ?>">
                                ...
                                <?php if ($buttons) : ?>
                                    <div class="flex flex-wrap justify-center gap-4">
                                        <?php foreach ($buttons as $btn_row) : 
                                            ...
                                            // Button Classes
                                            $base_class = 'inline-block py-3 px-8 rounded-full font-bold transition-all duration-300 no-underline';
                                            $style_class = '';
