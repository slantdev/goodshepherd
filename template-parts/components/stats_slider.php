            ...
            <div class="swiper stats-slider">
                <div class="swiper-wrapper items-stretch">
                    <?php foreach ($slides as $index => $slide) : 
                        ...
                        $text   = $slide['text'];
                    ?>
                        <div class="swiper-slide h-auto border-r border-current last:border-r-0 border-opacity-30">
                            <div class="px-6 md:px-8 flex flex-col h-full justify-between">
                                ...
                                <div class="flex items-center gap-4 mb-4">
                                    ...
                                    <!-- Number (2/3) -->
                                    <div class="w-2/3">
                                        <span class="text-4xl md:text-5xl lg:text-6xl font-bold leading-none block">
                                ...
                                <!-- Row 2 -->
                                <div class="text-lg md:text-xl font-medium leading-tight">
