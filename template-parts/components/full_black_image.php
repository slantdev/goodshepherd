...
<section <?php echo $section_id; ?> class="relative bg-black bg-no-repeat bg-bottom bg-contain overflow-hidden" style="background-color: <?php echo esc_attr($bg_color); ?>;">
