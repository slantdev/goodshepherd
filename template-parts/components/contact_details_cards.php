    ...
    <div class="container mx-auto px-4">
        ...
        <?php if ( have_rows('contact_details_cards') ) : ?>
            <div class="grid lg:grid-cols-2 gap-10">
                ...
                ?>
                    <div class="border border-purple-600 rounded-lg pt-10 px-6 md:px-12 pb-6 bg-white h-full shadow-sm hover:shadow-md transition-shadow">
                        
                        <?php if ( $card_title ) : ?>
                            <h3 class="text-purple-600 text-2xl font-semibold mb-6"><?php echo esc_html( $card_title ); ?></h3>
                        <?php endif; ?>
                            ...
                            <div class="space-y-4">
                                ...
                                ?>
                                    <div class="flex items-start">
                                        <?php if ( $icon ) : ?>
                                            <div class="flex-shrink-0 mr-6 hidden md:block text-purple-600">
                                                <?php echo goodshep_icon( array( 'icon' => $icon, 'class' => 'h-6 w-6 fill-current' ) ); ?>
                                            </div>
                                        <?php endif; ?>
